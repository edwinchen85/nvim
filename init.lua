...
vim.opt.guifont = "Hack Nerd Font Mono:h18" -- the font used in graphical neovim applications
...
vim.opt.diffopt = "vertical,filler,algorithm:histogram,indent-heuristic,hiddenoff"
vim.opt.tabstop = 4
